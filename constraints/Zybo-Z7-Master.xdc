...
##Clock signal
  set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS33 } [get_ports { main_clk_125 }]; #IO_L12P_T1_MRCC_35 Sch=sysclk
#create_clock -add -name sys_clk_pin -period 8.00 -waveform {0 4} [get_ports { sysclk }];


##Switches
   set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { rgb_renk_main[0]}]; #IO_L19N_T3_VREF_35 Sch=sw[0] #renk red sw0
   set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { rgb_renk_main[1]}]; #IO_L24P_T3_34 Sch=sw[1]      #renk green sw1
   set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { rgb_renk_main[2] }]; #IO_L4N_T0_34 Sch=sw[2]       #renk blue sw2
  # set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { harf_secilsinmi_main }]; #IO_L9P_T1_DQS_34 Sch=sw[3] #harfi yazdirma sw3


##Buttons
set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports { rst_main }]; #IO_L12N_T1_MRCC_35 Sch=btn[0]
set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports {  harf_secilsinmi_main }]; #IO_L24N_T3_34 Sch=btn[1]
#set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVCMOS33 } [get_ports { btn[2] }]; #IO_L10P_T1_AD11P_35 Sch=btn[2]
#set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { btn[3] }]; #IO_L7P_T1_34 Sch=btn[3]


##LEDs
   set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { kontrol_ledleri[0] }]; #IO_L23P_T3_35 Sch=led[0]
   set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { kontrol_ledleri[1] }]; #IO_L23N_T3_35 Sch=led[1]
   set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { kontrol_ledleri[2] }]; #IO_0_35 Sch=led[2]
   set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { kontrol_ledleri[3] }]; #IO_L3N_T0_DQS_AD1N_35 Sch=led[3]


##RGB LED 5 (Zybo Z7-20 only)
set_property -dict { PACKAGE_PIN Y11   IOSTANDARD LVCMOS33 } [get_ports { error_writing_reading[0] }]; #IO_L18N_T2_13 Sch=led5_r
...
##RGB LED 6
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { error_writing_reading[1] }]; #IO_L18P_T2_34 Sch=led6_r
...
#set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33     } [get_ports { scl_clock }]; #IO_L11P_T1_SRCC_13 Sch=jb_p[2]        
#set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33     } [get_ports { sda_data_output }]; #IO_L11N_T1_SRCC_13 Sch=jb_n[2]        
...
##Pmod Header JE                                                                                                                  
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { hsync_main }]; #IO_L4P_T0_34 Sch=je[1]	#jE1 hsync					 
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { vsync_main }]; #IO_L18N_T2_34 Sch=je[2]   #jE2 vsync                  
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { scl_clock }]; #IO_25_35 Sch=je[3]                          
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { sda_data_output }]; #IO_L19P_T3_35 Sch=je[4]                     
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { r_main }]; #IO_L3N_T0_DQS_34 Sch=je[7]    #jE7 r_main                
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { g_main }]; #IO_L9N_T1_DQS_34 Sch=je[8]     #jE8 g_main              
set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports { b_main }]; #IO_L20P_T3_34 Sch=je[9]        #jE9 b_main              
set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports {  hata_ledleri }]; #IO_L7N_T1_34 Sch=je[10]                    
